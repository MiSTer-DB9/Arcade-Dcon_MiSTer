...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Dcon_MiSTer.git"
CORE_NAME=(DCon)
...
UPSTREAM_CORE_NAME=(DCon)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(DCon.qpf)
COMPILATION_OUTPUT=(output_files/DCon.rbf)
